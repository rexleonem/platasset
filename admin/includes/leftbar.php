	<nav class="ts-sidebar">
			...
			<li><a href="transactions.php"><i class="fa fa-user"></i> &nbsp;Transactions</a>
			</li>
			<li><a href="withdrawals.php"><i class="fa fa-user"></i> &nbsp;Withdrawals</a>
			</li>
			...
			<p class="text-center" style="color:#ffffff; margin-top: 100px;">©2021 Platinum Asset</p>
		</nav>
