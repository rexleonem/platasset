...
if(isset($_POST['submit']))
  {
	...
	$sql="UPDATE withdrawal SET amount=(:amount), useremail=(:useremail), date=(:date), status=(:status) WHERE id=(:idedit)";
...
<head>
	...
	<title>Edit Withdrawal Request</title>
...
<body>
<?php
		$sql = "SELECT * from withdrawal where id = :editid";
		$query = $dbh -> prepare($sql);
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Edit Withdrawal Request: <?php echo htmlentities($result->name); ?></h3>
						<div class="row">
							<div class="col-md-12">
...
<div class="col-sm-4">
<input type="text" name="useremail" class="form-control" required value="<?php echo htmlentities($result->useremail);?>">
</div>
</div>
