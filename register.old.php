...
$sql ="INSERT INTO users(name,email, password, gender, mobile, btc_wallet, image, status) VALUES(:name, :email, :password, :gender, :mobileno, :btc_wallet, :image, 1)";
					...
					<div class="col-md-12">
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <label class="col-sm-1 control-label">BTC Wallet<span style="color:red">*</span></label>
                            <div class="col-sm-5">
                            <input type="text" name="btc_wallet" class="form-control" required>
                            </div>
                            </div>
